...
ALTER TABLE ONLY employee_schema.business_trip_expense
    ADD CONSTRAINT fki2voraj6uj6pmakkth5i1mtug FOREIGN KEY (currency_id) REFERENCES dictionary_schema.currency(id);
...
ALTER TABLE ONLY finance_schema.expense
    ADD CONSTRAINT fkfkdvf1ivs3l31iy5tf5ap3kul FOREIGN KEY (currency_id) REFERENCES dictionary_schema.currency(id);
...
ALTER TABLE ONLY ld_schema.external_learner
    ADD CONSTRAINT fkfwdq4x7dsap8gasi5u79n4u4h FOREIGN KEY (gender_id) REFERENCES dictionary_schema.gender(id);
...
ALTER TABLE ONLY ld_schema.external_instructor
    ADD CONSTRAINT fkk4lfax91sb3bcvghc8yhw9iv FOREIGN KEY (gender_id) REFERENCES dictionary_schema.gender(id);
