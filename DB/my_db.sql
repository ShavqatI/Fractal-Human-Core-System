...
--
-- Name: education; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.education (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    begin_date date,
...
ALTER TABLE employee_schema.education OWNER TO fractal;
...
ALTER TABLE employee_schema.education ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Data for Name: education; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.education (id, created_date, updated_date, begin_date, end_date, image, number, series, university, university_address, created_user_id, updated_user_id, education_document_type_id, education_type_id, employee_id, status_id, document_verified, institution_address, institution_name, is_foreign_institution, specialization, verification_notes, accreditation_status_id, degree_type_id, grade_point_average_id) FROM stdin;
\.
...
--
-- Name: education education_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.education
...
--
-- Name: education fk23y37u75qregx6obc8y907b87; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education fk2xt0s5mcujs2n7n7ipxo1ho07; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education fk8dpbwqpg0jd8gnmr94is1gbsb; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
ALTER TABLE ONLY employee_schema.education_resource
    ADD CONSTRAINT fkc26yy5lxdhi5qmv777e2mpt6x FOREIGN KEY (education_id) REFERENCES employee_schema.education(id);
...
--
-- Name: education fkfkb4mxbsjpn17dykxmuoy1n9m; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education fkhkops45a1klf1mnpvg6rsdbxv; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education fkid3099i5vcjl46o5m8mtea452; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education fkkhui07xo70funlw7srna0pph8; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education fkrphg8gbx569xvj1txkkt91uy4; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education fktohgygeab9v53147sbpg4cpdf; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
