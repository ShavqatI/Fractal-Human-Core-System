...
COPY organization_schema.department (id, created_date, updated_date, code, level, level_map, name, created_user_id, updated_user_id, organization_unit_id, parent_id, status_id) FROM stdin;
...
6	2025-08-04 10:49:14.374705	\N	UNIT	Unit	Unit under department	\N	\N
\.
