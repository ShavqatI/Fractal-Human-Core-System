...
3	2025-08-10 12:05:04.768303	\N	USD	USD	840	\N	\N	5
\.
...
2	2025-08-05 13:19:07.752497	\N	SPMANAGER	Manager technical support	Manager technical support	\N	\N	6	\N	5
3	2025-08-06 12:54:10.89373	\N	FWFWFF	qwfwqfwqf	fqfwfqf	\N	\N	7	\N	5
6	2025-08-06 13:02:29.050449	\N	POPOIPO	qweqweqweqwe	qwohqwohoiweqweqwewqe	\N	\N	5	\N	5
9	2025-08-09 10:53:36.159741	\N	UPUPWUPWUE	dqdqwd	NEW position	\N	\N	5	\N	5
\.
...
SELECT pg_catalog.setval('authorization_schema.permission_id_seq', 105, true);
...
SELECT pg_catalog.setval('dictionary_schema.currency_id_seq', 3, true);
...
SELECT pg_catalog.setval('localization_schema.layout_label_detail_id_seq', 121, true);
...
SELECT pg_catalog.setval('localization_schema.layout_label_id_seq', 51, true);
...
SELECT pg_catalog.setval('navigation_schema.menu_action_id_seq', 116, true);
...
SELECT pg_catalog.setval('navigation_schema.menu_id_seq', 56, true);
...
SELECT pg_catalog.setval('organization_schema.grade_id_seq', 1, true);
...
SELECT pg_catalog.setval('organization_schema.grade_level_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.grade_step_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.position_id_seq', 11, true);
