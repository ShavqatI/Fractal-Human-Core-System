...
DROP DATABASE IF EXISTS fractal;
--
-- Name: fractal; Type: DATABASE; Schema: -; Owner: fractal
--

CREATE DATABASE fractal WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE fractal OWNER TO fractal;
...
--
-- Name: areaType; Type: TABLE; Schema: dictionary_schema; Owner: fractal
--

CREATE TABLE dictionary_schema.areaType (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    code character varying(255),
...
ALTER TABLE dictionary_schema.areaType OWNER TO fractal;

--
-- Name: gender_id_seq; Type: SEQUENCE; Schema: dictionary_schema; Owner: fractal
--

ALTER TABLE dictionary_schema.areaType ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: accreditation_status; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.accreditation_status (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    code character varying(255),
...
ALTER TABLE employee_schema.accreditation_status OWNER TO fractal;

--
-- Name: accreditation_status_id_seq; Type: SEQUENCE; Schema: employee_schema; Owner: fractal
--

ALTER TABLE employee_schema.accreditation_status ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME employee_schema.accreditation_status_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: candidate_citizenship; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.candidate_citizenship (
    id bigint NOT NULL,
    candidate_id bigint
);


ALTER TABLE employee_schema.candidate_citizenship OWNER TO fractal;
...
--
-- Name: employeeEducation; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.employeeEducation (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    begin_date date,
    ...
    university_address character varying(255),
    created_user_id bigint,
    updated_user_id bigint,
...
ALTER TABLE employee_schema.employeeEducation OWNER TO fractal;

--
-- Name: education_document_type; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.education_document_type (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    code character varying(255),
...
ALTER TABLE employee_schema.education_document_type OWNER TO fractal;

--
-- Name: education_document_type_id_seq; Type: SEQUENCE; Schema: employee_schema; Owner: fractal
--

ALTER TABLE employee_schema.education_document_type ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME employee_schema.education_document_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: education_id_seq; Type: SEQUENCE; Schema: employee_schema; Owner: fractal
--

ALTER TABLE employee_schema.employeeEducation ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME employee_schema.education_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: education_resource; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.education_resource (
    id bigint NOT NULL,
    education_id bigint
);


ALTER TABLE employee_schema.education_resource OWNER TO fractal;

--
-- Name: education_type; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.education_type (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    code character varying(255),
...
ALTER TABLE employee_schema.education_type OWNER TO fractal;

--
-- Name: education_type_id_seq; Type: SEQUENCE; Schema: employee_schema; Owner: fractal
--

ALTER TABLE employee_schema.education_type ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME employee_schema.education_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: grade_point_average; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.grade_point_average (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
...
ALTER TABLE employee_schema.grade_point_average OWNER TO fractal;

--
-- Name: grade_point_average_id_seq; Type: SEQUENCE; Schema: employee_schema; Owner: fractal
--

ALTER TABLE employee_schema.grade_point_average ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME employee_schema.grade_point_average_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: identification_document; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.identification_document (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    expiry_date date,
...
ALTER TABLE employee_schema.identification_document OWNER TO fractal;

--
-- Name: identification_document_id_seq; Type: SEQUENCE; Schema: employee_schema; Owner: fractal
--

ALTER TABLE employee_schema.identification_document ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME employee_schema.identification_document_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: identification_document_type; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.identification_document_type (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    code character varying(255),
...
ALTER TABLE employee_schema.identification_document_type OWNER TO fractal;

--
-- Name: identification_document_type_id_seq; Type: SEQUENCE; Schema: employee_schema; Owner: fractal
--

ALTER TABLE employee_schema.identification_document_type ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME employee_schema.identification_document_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: group; Type: TABLE; Schema: user_schema; Owner: fractal
--
...
ALTER TABLE user_schema."group" OWNER TO fractal;

--
-- Name: group_id_seq; Type: SEQUENCE; Schema: user_schema; Owner: fractal
--

ALTER TABLE user_schema."group" ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME user_schema.group_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: permissions; Type: TABLE; Schema: user_schema; Owner: fractal
--
...
ALTER TABLE user_schema.permissions OWNER TO fractal;

--
-- Name: permissions_id_seq; Type: SEQUENCE; Schema: user_schema; Owner: fractal
--

ALTER TABLE user_schema.permissions ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME user_schema.permissions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_group_menu; Type: TABLE; Schema: user_schema; Owner: fractal
--

CREATE TABLE user_schema.user_group_menu (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    confirm_date timestamp(6) without time zone,
...
ALTER TABLE user_schema.user_group_menu OWNER TO fractal;

--
-- Name: user_group_menu_id_seq; Type: SEQUENCE; Schema: user_schema; Owner: fractal
--

ALTER TABLE user_schema.user_group_menu ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME user_schema.user_group_menu_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_groups; Type: TABLE; Schema: user_schema; Owner: fractal
--

CREATE TABLE user_schema.user_groups (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    is_active boolean,
...
ALTER TABLE user_schema.user_groups OWNER TO fractal;

--
-- Name: user_groups_id_seq; Type: SEQUENCE; Schema: user_schema; Owner: fractal
--

ALTER TABLE user_schema.user_groups ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME user_schema.user_groups_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
7	2025-08-07 12:55:41.581431	2025-08-07 12:55:45.733054	t	t	t	t	$2a$10$DHaLIwlgkJawSe6QVWIul.31gQV57NgKu6OwK7303tu8mqfxuJjxu	fwefewcwq	\N	\N
\.
...
4	2025-08-04 12:39:03.678907	\N	\N	\N	99052446464646	1
5	2025-08-04 12:39:15.288694	\N	\N	\N	gfdjsgfjsdg@mahfhhkdf.ru	3
7	2025-08-04 13:52:50.52649	2025-08-04 13:59:35.128662	\N	\N	fgsdgfj@fsfskd;fk	3
...
--
-- Data for Name: areaType; Type: TABLE DATA; Schema: dictionary_schema; Owner: fractal
--

COPY dictionary_schema.areaType (id, created_date, updated_date, code, name, created_user_id, updated_user_id) FROM stdin;
...
--
-- Data for Name: accreditation_status; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.accreditation_status (id, created_date, updated_date, code, name, created_user_id, updated_user_id) FROM stdin;
\.
...
3	2025-08-10 11:47:28.203639	\N	OKKK	okkkk	okkkk	\N	\N
\.


--
-- Data for Name: candidate_citizenship; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.candidate_citizenship (id, candidate_id) FROM stdin;
\.
...
COPY employee_schema.category (id, created_date, updated_date, code, name, created_user_id, updated_user_id) FROM stdin;
1	2025-07-13 07:00:11.688298	2025-07-18 10:50:00.583354	TAJIK	Tajik	\N	\N
5	2025-07-18 11:13:38.221164	\N	UZBEK	Uzbek	\N	\N
\.
...
--
-- Data for Name: employeeEducation; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.employeeEducation (id, created_date, updated_date, begin_date, end_date, image, number, series, university, university_address, created_user_id, updated_user_id, education_document_type_id, education_type_id, employee_id, status_id, document_verified, institution_address, institution_name, is_foreign_institution, specialization, verification_notes, accreditation_status_id, degree_type_id, grade_point_average_id) FROM stdin;
\.


--
-- Data for Name: education_document_type; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.education_document_type (id, created_date, updated_date, code, name, created_user_id, updated_user_id) FROM stdin;
\.


--
-- Data for Name: education_resource; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.education_resource (id, education_id) FROM stdin;
\.


--
-- Data for Name: education_type; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.education_type (id, created_date, updated_date, code, name, created_user_id, updated_user_id) FROM stdin;
\.
...
--
-- Data for Name: grade_point_average; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.grade_point_average (id, created_date, updated_date, scale, value, created_user_id, updated_user_id) FROM stdin;
\.


--
-- Data for Name: identification_document; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.identification_document (id, created_date, updated_date, expiry_date, issue_date, issue_organization, issue_organization_address, number, series, term_in_years, created_user_id, updated_user_id, employee_id, identification_type_id, status_id) FROM stdin;
\.
...
--
-- Data for Name: identification_document_type; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.identification_document_type (id, created_date, updated_date, code, name, created_user_id, updated_user_id) FROM stdin;
\.
...
6	2025-07-23 11:58:32.951626	\N	areaType	\N	\N
...
3	2025-07-15 09:05:29.149532	\N	REGISTRATION	Registration	\N	\N
5	2025-07-18 10:49:25.731305	2025-07-28 13:58:38.016502	FACT	Facticheskiy	\N	\N
\.
...
COPY location_schema.city (id, created_date, updated_date, code, name, created_user_id, updated_user_id, region_id) FROM stdin;
4	2025-07-16 13:41:49.45795	2025-07-16 13:44:11.181922	JBALKHI	Чалолиддини Руми	\N	\N	3
6	2025-07-16 13:42:13.807187	2025-07-16 13:44:21.398899	BUSTON	Бустон	\N	\N	4
5	2025-07-16 13:42:01.436512	2025-07-16 13:44:30.66304	KHUJAND	Хучанд	\N	\N	4
\.
...
COPY location_schema.district (id, created_date, updated_date, code, name, created_user_id, updated_user_id, city_id, region_id) FROM stdin;
3	2025-08-02 11:09:43.78903	\N	RDK	Rudaki	\N	\N	5	4
\.
...
2	2025-07-23 12:05:06.992077	2025-07-28 11:21:08.592145	\N	MALE	2	Gender	1	areaType	\N	\N	6	1
...
COPY organization_schema.separationReason (id, created_date, updated_date, code, level, level_map, name, created_user_id, updated_user_id, organization_unit_id, parent_id, status_id) FROM stdin;
6	2025-08-05 13:18:26.49287	\N	SUPPORT	2	001-01	Support	\N	\N	6	5	5
7	2025-08-06 09:15:08.494932	\N	PROGRAMMING	2	001-02	Programming	\N	\N	6	5	5
8	2025-08-06 09:15:48.456186	\N	INFRACT	2	001-03	Infrastructure	\N	\N	6	5	5
5	2025-08-05 13:17:52.722003	2025-08-09 10:07:42.211583	ITDEPART	1	001	IT Department	\N	\N	5	\N	3
\.
...
COPY organization_schema.organization (id, created_date, updated_date, close_date, code, full_name, level, level_map, name, open_date, tin_number, created_user_id, updated_user_id, organization_unit_id, parent_id) FROM stdin;
1	2025-08-02 11:21:49.097093	\N	\N	FRACTAL	FRACTAL Company	1	001	LLC FRACTAL	2025-08-28	1313131	\N	\N	1	\N
6	2025-08-04 13:52:50.511233	2025-08-04 14:01:51.553072	2025-08-01	ONE	one  one	1	002	onedfsdfsdfaf	2026-02-04	464646	\N	\N	1	\N
5	2025-08-04 10:01:26.509557	2025-08-09 10:26:47.860321	\N	BRCH	LL new bracnch	2	001-01	SINO	2025-09-03	464646	\N	\N	3	1
\.
...
3	2025-08-02 13:03:22.084534	\N	BRANCH	Branch	branch	\N	\N
5	2025-08-04 10:48:50.903989	\N	DEPARTMENT	Department	Department	\N	\N
6	2025-08-04 10:49:14.374705	\N	UNIT	Unit	Unit under separationReason	\N	\N
\.
...
COPY organization_schema."position" (id, created_date, updated_date, code, description, name, created_user_id, updated_user_id, department_id, grade_id, status_id) FROM stdin;
2	2025-08-05 13:19:07.752497	2025-08-12 18:10:26.061845	SPMANAGER	Manager technical update	Manager technical update	\N	\N	6	4	5
12	2025-08-12 17:47:01.316103	2025-08-12 18:10:57.356805	HUMAN	Human Right	Human Right	\N	\N	6	4	5
\.
...
COPY recruitment_schema.candidate (id, created_date, updated_date, birth_date, first_name, last_name, patronymic_name, ssn, tin, created_user_id, updated_user_id, gender_id, marital_status_id, nationality_id, vacancy_id) FROM stdin;
\.
...
--
-- Data for Name: group; Type: TABLE DATA; Schema: user_schema; Owner: fractal
--

COPY user_schema."group" (id, created_date, updated_date, code, name, created_user_id, updated_user_id) FROM stdin;
\.


--
-- Data for Name: permissions; Type: TABLE DATA; Schema: user_schema; Owner: fractal
--

COPY user_schema.permissions (id, created_date, updated_date, confirm_date, is_active, created_user_id, updated_user_id, confirm_user_id, group_id, menu_action_id, status_id) FROM stdin;
\.
...
--
-- Data for Name: user_group_menu; Type: TABLE DATA; Schema: user_schema; Owner: fractal
--

COPY user_schema.user_group_menu (id, created_date, updated_date, confirm_date, created_user_id, updated_user_id, confirm_user_id, group_id, menu_id, status_id) FROM stdin;
\.


--
-- Data for Name: user_groups; Type: TABLE DATA; Schema: user_schema; Owner: fractal
--

COPY user_schema.user_groups (id, created_date, updated_date, is_active, created_user_id, updated_user_id, group_id, user_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('authorization_schema.permission_id_seq', 110, true);
...
SELECT pg_catalog.setval('authorization_schema.role_id_seq', 6, true);
...
SELECT pg_catalog.setval('authorization_schema.role_menu_id_seq', 40, true);
...
SELECT pg_catalog.setval('authorization_schema.user_id_seq', 7, true);
...
SELECT pg_catalog.setval('authorization_schema.user_role_id_seq', 8, true);
...
SELECT pg_catalog.setval('dictionary_schema.marital_status_id_seq', 7, true);
...
--
-- Name: accreditation_status_id_seq; Type: SEQUENCE SET; Schema: employee_schema; Owner: fractal
--

SELECT pg_catalog.setval('employee_schema.accreditation_status_id_seq', 1, false);
...
SELECT pg_catalog.setval('employee_schema.category_id_seq', 6, true);
...
--
-- Name: education_document_type_id_seq; Type: SEQUENCE SET; Schema: employee_schema; Owner: fractal
--

SELECT pg_catalog.setval('employee_schema.education_document_type_id_seq', 1, false);


--
-- Name: education_id_seq; Type: SEQUENCE SET; Schema: employee_schema; Owner: fractal
--

SELECT pg_catalog.setval('employee_schema.education_id_seq', 1, false);


--
-- Name: education_type_id_seq; Type: SEQUENCE SET; Schema: employee_schema; Owner: fractal
--

SELECT pg_catalog.setval('employee_schema.education_type_id_seq', 1, false);
...
--
-- Name: grade_point_average_id_seq; Type: SEQUENCE SET; Schema: employee_schema; Owner: fractal
--

SELECT pg_catalog.setval('employee_schema.grade_point_average_id_seq', 1, false);


--
-- Name: identification_document_id_seq; Type: SEQUENCE SET; Schema: employee_schema; Owner: fractal
--

SELECT pg_catalog.setval('employee_schema.identification_document_id_seq', 1, false);


--
-- Name: identification_document_type_id_seq; Type: SEQUENCE SET; Schema: employee_schema; Owner: fractal
--

SELECT pg_catalog.setval('employee_schema.identification_document_type_id_seq', 1, false);
...
SELECT pg_catalog.setval('employee_schema.order_type_id_seq', 1, false);
...
SELECT pg_catalog.setval('employee_schema.performance_type_id_seq', 1, false);
...
SELECT pg_catalog.setval('employee_schema.relation_type_id_seq', 1, false);
...
SELECT pg_catalog.setval('employee_schema.subordinate_type_id_seq', 3, true);
...
SELECT pg_catalog.setval('employee_schema.vacation_type_id_seq', 1, false);
...
SELECT pg_catalog.setval('localization_schema.layout_label_detail_id_seq', 124, true);
...
SELECT pg_catalog.setval('localization_schema.layout_label_id_seq', 52, true);
...
SELECT pg_catalog.setval('location_schema.address_type_id_seq', 6, true);
...
SELECT pg_catalog.setval('location_schema.city_id_seq', 7, true);
...
SELECT pg_catalog.setval('location_schema.district_id_seq', 3, true);
...
SELECT pg_catalog.setval('navigation_schema.action_id_seq', 5, true);
...
SELECT pg_catalog.setval('navigation_schema.menu_action_id_seq', 119, true);
...
SELECT pg_catalog.setval('navigation_schema.menu_id_seq', 57, true);
...
SELECT pg_catalog.setval('organization_schema.accountability_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.authority_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.department_id_seq', 8, true);
...
SELECT pg_catalog.setval('organization_schema.grade_id_seq', 4, true);
...
SELECT pg_catalog.setval('organization_schema.grade_step_id_seq', 2, true);
...
SELECT pg_catalog.setval('organization_schema.job_description_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.key_performance_indicator_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.organization_id_seq', 6, true);
...
SELECT pg_catalog.setval('organization_schema.organization_unit_id_seq', 6, true);
...
SELECT pg_catalog.setval('organization_schema.position_id_seq', 12, true);
...
SELECT pg_catalog.setval('organization_schema.qualification_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.reporting_line_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.reporting_line_type_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.required_experience_id_seq', 1, false);
...
SELECT pg_catalog.setval('organization_schema.responsibility_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.address_seq', 201, true);
...
SELECT pg_catalog.setval('public.contact_seq', 101, true);
...
SELECT pg_catalog.setval('recruitment_schema.candidate_id_seq', 1, false);
...
--
-- Name: group_id_seq; Type: SEQUENCE SET; Schema: user_schema; Owner: fractal
--

SELECT pg_catalog.setval('user_schema.group_id_seq', 1, false);


--
-- Name: permissions_id_seq; Type: SEQUENCE SET; Schema: user_schema; Owner: fractal
--

SELECT pg_catalog.setval('user_schema.permissions_id_seq', 1, false);
...
--
-- Name: user_group_menu_id_seq; Type: SEQUENCE SET; Schema: user_schema; Owner: fractal
--

SELECT pg_catalog.setval('user_schema.user_group_menu_id_seq', 1, false);


--
-- Name: user_groups_id_seq; Type: SEQUENCE SET; Schema: user_schema; Owner: fractal
--

SELECT pg_catalog.setval('user_schema.user_groups_id_seq', 1, false);
...
--
-- Name: areaType gender_pkey; Type: CONSTRAINT; Schema: dictionary_schema; Owner: fractal
--

ALTER TABLE ONLY dictionary_schema.areaType
...
--
-- Name: areaType ukmxvfcsf1euhi5hsw1uecvke7b; Type: CONSTRAINT; Schema: dictionary_schema; Owner: fractal
--
...
--
-- Name: accreditation_status accreditation_status_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.accreditation_status
...
--
-- Name: candidate_citizenship candidate_citizenship_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.candidate_citizenship
...
--
-- Name: education_document_type education_document_type_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.education_document_type
    ADD CONSTRAINT education_document_type_pkey PRIMARY KEY (id);


--
-- Name: employeeEducation education_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.employeeEducation
    ADD CONSTRAINT education_pkey PRIMARY KEY (id);


--
-- Name: education_resource education_resource_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.education_resource
    ADD CONSTRAINT education_resource_pkey PRIMARY KEY (id);


--
-- Name: education_type education_type_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.education_type
...
--
-- Name: grade_point_average grade_point_average_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.grade_point_average
    ADD CONSTRAINT grade_point_average_pkey PRIMARY KEY (id);


--
-- Name: identification_document identification_document_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.identification_document
...
--
-- Name: identification_document_type identification_document_type_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.identification_document_type
...
--
-- Name: identification_document_type uk2dxiha4nh0a2kcxd2o4o3tshf; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education_type ukbs1eww46yx7tfr1mmj1992mwo; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: accreditation_status uklpn2bhq1jq2wwib5drvl636eq; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education_document_type uksf750v55q844hxbs563cjn5m6; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: group group_pkey; Type: CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema."group"
    ADD CONSTRAINT group_pkey PRIMARY KEY (id);


--
-- Name: permissions permissions_pkey; Type: CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.permissions
...
--
-- Name: user_group_menu user_group_menu_pkey; Type: CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_group_menu
    ADD CONSTRAINT user_group_menu_pkey PRIMARY KEY (id);


--
-- Name: user_groups user_groups_pkey; Type: CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_groups
...
--
-- Name: areaType fk1tq6qdh89422se45pax0grn09; Type: FK CONSTRAINT; Schema: dictionary_schema; Owner: fractal
--
...
--
-- Name: areaType fkfbabbrlhfpcge0qak10pvkn3k; Type: FK CONSTRAINT; Schema: dictionary_schema; Owner: fractal
--
...
--
-- Name: education_type fk1i41pramnkarrbgnvju7v1tli; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.education_type
    ADD CONSTRAINT fk1i41pramnkarrbgnvju7v1tli FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);
...
--
-- Name: employeeEducation fk23y37u75qregx6obc8y907b87; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.employeeEducation
    ADD CONSTRAINT fk23y37u75qregx6obc8y907b87 FOREIGN KEY (education_document_type_id) REFERENCES employee_schema.education_document_type(id);
...
--
-- Name: employeeEducation fk2xt0s5mcujs2n7n7ipxo1ho07; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.employeeEducation
    ADD CONSTRAINT fk2xt0s5mcujs2n7n7ipxo1ho07 FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);
...
--
-- Name: education_resource fk3ioofgha55f9qsxf665fl76hv; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: identification_document_type fk3wrrux5ijujd14bkefa1j8xhc; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.identification_document_type
    ADD CONSTRAINT fk3wrrux5ijujd14bkefa1j8xhc FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);
...
ALTER TABLE ONLY employee_schema.employee_citizenship
    ADD CONSTRAINT fk4eoimi5t12nl2wlen7pe5u6jf FOREIGN KEY (id) REFERENCES employee_schema.citizenship(id);
...
--
-- Name: accreditation_status fk53gqywq4nuwrnrcck11wv6b44; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.accreditation_status
    ADD CONSTRAINT fk53gqywq4nuwrnrcck11wv6b44 FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);
...
--
-- Name: employeeEducation fk8dpbwqpg0jd8gnmr94is1gbsb; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.employeeEducation
    ADD CONSTRAINT fk8dpbwqpg0jd8gnmr94is1gbsb FOREIGN KEY (accreditation_status_id) REFERENCES employee_schema.accreditation_status(id);
...
--
-- Name: identification_document fk9fhx2j37s5l15ccoj7mjl9afd; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: identification_document fka09iqrithni1n9ngx9vwfhr81; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.identification_document
    ADD CONSTRAINT fka09iqrithni1n9ngx9vwfhr81 FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);
...
--
-- Name: grade_point_average fkb830fjxi2tf4antgy2r970pyy; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.grade_point_average
    ADD CONSTRAINT fkb830fjxi2tf4antgy2r970pyy FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);
...
--
-- Name: accreditation_status fkbrwbgditk56ui01dh4p61h6kh; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.accreditation_status
    ADD CONSTRAINT fkbrwbgditk56ui01dh4p61h6kh FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);
...
--
-- Name: education_resource fkc26yy5lxdhi5qmv777e2mpt6x; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.education_resource
    ADD CONSTRAINT fkc26yy5lxdhi5qmv777e2mpt6x FOREIGN KEY (education_id) REFERENCES employee_schema.employeeEducation(id);
...
--
-- Name: education_document_type fkdqv0twdc3y2y68k8boarvdnn2; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.education_document_type
    ADD CONSTRAINT fkdqv0twdc3y2y68k8boarvdnn2 FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);
...
ALTER TABLE ONLY employee_schema.employee
    ADD CONSTRAINT fke0w26qjedr99vwno4pqauw9i9 FOREIGN KEY (gender_id) REFERENCES dictionary_schema.areaType(id);
...
--
-- Name: employeeEducation fkfkb4mxbsjpn17dykxmuoy1n9m; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.employeeEducation
    ADD CONSTRAINT fkfkb4mxbsjpn17dykxmuoy1n9m FOREIGN KEY (grade_point_average_id) REFERENCES employee_schema.grade_point_average(id);
...
--
-- Name: candidate_citizenship fkgskf1mqa9868hnmg8vthw2ca0; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.candidate_citizenship
    ADD CONSTRAINT fkgskf1mqa9868hnmg8vthw2ca0 FOREIGN KEY (id) REFERENCES employee_schema.citizenship(id);
...
--
-- Name: employeeEducation fkhkops45a1klf1mnpvg6rsdbxv; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.employeeEducation
    ADD CONSTRAINT fkhkops45a1klf1mnpvg6rsdbxv FOREIGN KEY (degree_type_id) REFERENCES employee_schema.degree_type(id);
...
--
-- Name: grade_point_average fkibb94svl1rnxnrk5ta2pb11tc; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.grade_point_average
    ADD CONSTRAINT fkibb94svl1rnxnrk5ta2pb11tc FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);


--
-- Name: identification_document fkicxgrtk7s9lhqqs7mbld5w9ie; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.identification_document
    ADD CONSTRAINT fkicxgrtk7s9lhqqs7mbld5w9ie FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);


--
-- Name: employeeEducation fkid3099i5vcjl46o5m8mtea452; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.employeeEducation
    ADD CONSTRAINT fkid3099i5vcjl46o5m8mtea452 FOREIGN KEY (education_type_id) REFERENCES employee_schema.education_type(id);
...
ALTER TABLE ONLY employee_schema.relative
    ADD CONSTRAINT fkis2bmbjevbyykx3r3kwqennmo FOREIGN KEY (gender_id) REFERENCES dictionary_schema.areaType(id);
...
--
-- Name: identification_document_type fkjqgrau3xkgox0gvgax2dec0aw; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.identification_document_type
    ADD CONSTRAINT fkjqgrau3xkgox0gvgax2dec0aw FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);
...
--
-- Name: identification_document fkk33mn08bfsluu4b4udlwty3oe; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.identification_document
    ADD CONSTRAINT fkk33mn08bfsluu4b4udlwty3oe FOREIGN KEY (identification_type_id) REFERENCES employee_schema.identification_document_type(id);
...
--
-- Name: employeeEducation fkkhui07xo70funlw7srna0pph8; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: education_type fkktgwip7bg4ly8sbwpelhg2ld3; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.education_type
    ADD CONSTRAINT fkktgwip7bg4ly8sbwpelhg2ld3 FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);
...
ALTER TABLE ONLY employee_schema.identification_document_resource
    ADD CONSTRAINT fknege5cbi5n8p5hrl4cd4kqw9i FOREIGN KEY (identification_document_id) REFERENCES employee_schema.identification_document(id);
...
--
-- Name: education_document_type fko6r7h9nihgo3t0t1iccw0larx; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.education_document_type
    ADD CONSTRAINT fko6r7h9nihgo3t0t1iccw0larx FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);
...
--
-- Name: candidate_citizenship fkovkfrsv3e4uc0f4yctmc99gyu; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: identification_document fkpdj5uhngsvi2ifw5x7hmpau98; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.identification_document
    ADD CONSTRAINT fkpdj5uhngsvi2ifw5x7hmpau98 FOREIGN KEY (employee_id) REFERENCES employee_schema.employee(id);
...
--
-- Name: employeeEducation fkrphg8gbx569xvj1txkkt91uy4; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.employeeEducation
    ADD CONSTRAINT fkrphg8gbx569xvj1txkkt91uy4 FOREIGN KEY (employee_id) REFERENCES employee_schema.employee(id);
...
--
-- Name: employeeEducation fktohgygeab9v53147sbpg4cpdf; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.employeeEducation
    ADD CONSTRAINT fktohgygeab9v53147sbpg4cpdf FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);
...
ALTER TABLE ONLY recruitment_schema.candidate
    ADD CONSTRAINT fkl3y9fhd8h6cy4c0y120c0j3hx FOREIGN KEY (gender_id) REFERENCES dictionary_schema.areaType(id);
...
--
-- Name: permissions fk1cc2ss4wvgqrjmthbvuwnklw3; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.permissions
    ADD CONSTRAINT fk1cc2ss4wvgqrjmthbvuwnklw3 FOREIGN KEY (menu_action_id) REFERENCES navigation_schema.menu_action(id);


--
-- Name: user_group_menu fk4cvwb4u3uimoyqpyg76hv03de; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_group_menu
    ADD CONSTRAINT fk4cvwb4u3uimoyqpyg76hv03de FOREIGN KEY (menu_id) REFERENCES navigation_schema.menu(id);


--
-- Name: user_group_menu fk626x9lvromwaom8spkakgoqkd; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_group_menu
    ADD CONSTRAINT fk626x9lvromwaom8spkakgoqkd FOREIGN KEY (confirm_user_id) REFERENCES user_schema."user"(id);


--
-- Name: permissions fk6atqrs12swde7pcmoegi7r4gc; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.permissions
    ADD CONSTRAINT fk6atqrs12swde7pcmoegi7r4gc FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);


--
-- Name: permissions fk6oh8s8ojdsl1hnrj0vwcu51xa; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.permissions
    ADD CONSTRAINT fk6oh8s8ojdsl1hnrj0vwcu51xa FOREIGN KEY (group_id) REFERENCES user_schema."group"(id);


--
-- Name: permissions fk7a5ue6i1y5ipryl7d2bas7v7o; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.permissions
    ADD CONSTRAINT fk7a5ue6i1y5ipryl7d2bas7v7o FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);


--
-- Name: user_group_menu fk84mvepk6gv983pwbfywvbk68g; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_group_menu
    ADD CONSTRAINT fk84mvepk6gv983pwbfywvbk68g FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);


--
-- Name: user_group_menu fk9lv6fqov8oexdbqyytrcvm9tp; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_group_menu
    ADD CONSTRAINT fk9lv6fqov8oexdbqyytrcvm9tp FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);
...
ALTER TABLE ONLY user_schema.profile
    ADD CONSTRAINT fkae2yd89np7xx5kfphsq4osgkn FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);
...
ALTER TABLE ONLY user_schema.profile
    ADD CONSTRAINT fkawh070wpue34wqvytjqr4hj5e FOREIGN KEY (user_id) REFERENCES user_schema."user"(id);
...
ALTER TABLE ONLY user_schema.profile
    ADD CONSTRAINT fkdediqdt2rpmb5bicw7upyusjy FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);


--
-- Name: group fkdxyuidg61394254nvbhwhon84; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema."group"
    ADD CONSTRAINT fkdxyuidg61394254nvbhwhon84 FOREIGN KEY (created_user_id) REFERENCES user_schema."user"(id);


--
-- Name: user_groups fkgwx9c9uksaipucor3g55fxqbe; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_groups
    ADD CONSTRAINT fkgwx9c9uksaipucor3g55fxqbe FOREIGN KEY (created_user_id) REFERENCES authorization_schema."user"(id);


--
-- Name: user_groups fkhhrfi7x3ydm11iofjkhvw0jh7; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_groups
    ADD CONSTRAINT fkhhrfi7x3ydm11iofjkhvw0jh7 FOREIGN KEY (group_id) REFERENCES user_schema."group"(id);
...
--
-- Name: permissions fkjhhimp4yi42qcabp1fjatahkh; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.permissions
    ADD CONSTRAINT fkjhhimp4yi42qcabp1fjatahkh FOREIGN KEY (confirm_user_id) REFERENCES user_schema."user"(id);
...
--
-- Name: user_group_menu fklmd7a762yextbr6vihn9lwppw; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_group_menu
    ADD CONSTRAINT fklmd7a762yextbr6vihn9lwppw FOREIGN KEY (group_id) REFERENCES user_schema."group"(id);


--
-- Name: group fkndw7232dvmduhlh047cbm3w66; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema."group"
    ADD CONSTRAINT fkndw7232dvmduhlh047cbm3w66 FOREIGN KEY (updated_user_id) REFERENCES user_schema."user"(id);


--
-- Name: permissions fkotof5dgmhi3cs4m2lfxbkei65; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.permissions
    ADD CONSTRAINT fkotof5dgmhi3cs4m2lfxbkei65 FOREIGN KEY (status_id) REFERENCES dictionary_schema.expenseType(id);
...
--
-- Name: user_groups fkpopdc8mcm3ov088bi37opjjdu; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_groups
    ADD CONSTRAINT fkpopdc8mcm3ov088bi37opjjdu FOREIGN KEY (updated_user_id) REFERENCES authorization_schema."user"(id);


--
-- Name: user_group_menu fkt2pjec8asvwoka6wjg2cgybts; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_group_menu
    ADD CONSTRAINT fkt2pjec8asvwoka6wjg2cgybts FOREIGN KEY (status_id) REFERENCES dictionary_schema.expenseType(id);


--
-- Name: user_groups fkxgk67l5yp8458l39rog6nppe; Type: FK CONSTRAINT; Schema: user_schema; Owner: fractal
--

ALTER TABLE ONLY user_schema.user_groups
    ADD CONSTRAINT fkxgk67l5yp8458l39rog6nppe FOREIGN KEY (user_id) REFERENCES authorization_schema."user"(id);
