...
ALTER TABLE ONLY user_schema.permissions
    ADD CONSTRAINT fkotof5dgmhi3cs4m2lfxbkei65 FOREIGN KEY (status_id) REFERENCES dictionary_schema.status(id);
...
ALTER TABLE ONLY user_schema.user_group_menu
    ADD CONSTRAINT fkt2pjec8asvwoka6wjg2cgybts FOREIGN KEY (status_id) REFERENCES dictionary_schema.status(id);
