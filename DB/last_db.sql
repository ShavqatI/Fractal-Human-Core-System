...
ALTER TABLE IF EXISTS ONLY employee_schema.internalEmploymentAgreement DROP CONSTRAINT IF EXISTS fkkah6fs7sm3547pw8vsihgsr5o;
...
ALTER TABLE IF EXISTS ONLY employee_schema.internalEmploymentAgreement DROP CONSTRAINT IF EXISTS fkfn0s7iuoe8tyvl9ds15sgeiwl;
...
ALTER TABLE IF EXISTS ONLY employee_schema.internalEmploymentAgreement DROP CONSTRAINT IF EXISTS fk7uujhe6vgm7ecsxfpfk4458et;
ALTER TABLE IF EXISTS ONLY employee_schema.internalEmploymentAgreement DROP CONSTRAINT IF EXISTS fk7t04a71205tk67nr8wle31yie;
...
ALTER TABLE IF EXISTS ONLY employee_schema.internalEmploymentAgreement DROP CONSTRAINT IF EXISTS agreement_pkey;
...
DROP TABLE IF EXISTS employee_schema.internalEmploymentAgreement;
...
--
-- Name: internalEmploymentAgreement; Type: TABLE; Schema: employee_schema; Owner: fractal
--

CREATE TABLE employee_schema.internalEmploymentAgreement (
    id bigint NOT NULL,
    created_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_date timestamp(6) without time zone,
    end_date date,
...
ALTER TABLE employee_schema.internalEmploymentAgreement OWNER TO fractal;

--
-- Name: agreement_id_seq; Type: SEQUENCE; Schema: employee_schema; Owner: fractal
--

ALTER TABLE employee_schema.internalEmploymentAgreement ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Data for Name: internalEmploymentAgreement; Type: TABLE DATA; Schema: employee_schema; Owner: fractal
--

COPY employee_schema.internalEmploymentAgreement (id, created_date, updated_date, end_date, number, start_date, created_user_id, updated_user_id, employment_history_id, status_id) FROM stdin;
\.
...
--
-- Name: internalEmploymentAgreement agreement_pkey; Type: CONSTRAINT; Schema: employee_schema; Owner: fractal
--

ALTER TABLE ONLY employee_schema.internalEmploymentAgreement
...
ALTER TABLE ONLY employee_schema.agreement_resource
    ADD CONSTRAINT fk4jygosnp0b318rmclfieoq99x FOREIGN KEY (agreement_id) REFERENCES employee_schema.internalEmploymentAgreement(id);
...
--
-- Name: internalEmploymentAgreement fk7t04a71205tk67nr8wle31yie; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: internalEmploymentAgreement fk7uujhe6vgm7ecsxfpfk4458et; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: internalEmploymentAgreement fkfn0s7iuoe8tyvl9ds15sgeiwl; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
...
--
-- Name: internalEmploymentAgreement fkkah6fs7sm3547pw8vsihgsr5o; Type: FK CONSTRAINT; Schema: employee_schema; Owner: fractal
--
