...
public class CandidateUseCaseServiceImpl implements CandidateUseCaseService {
    ...
    public void hire(Long id) {
      ...
      Employee employee = Employee.builder()
              ...
              .build();
      candidate.getIdentificationDocuments().forEach(identificationDocument -> employee.addIdentificationDocument(employeeIdentificationDocumentMapperService.convert(EmployeeIdentificationDocument.builder().build(),identificationDocument)));
      ...
      candidate.getEducations().forEach(education-> employee.addEducation(employeeEducationMapperService.convert(EmployeeEducation.builder().build(),education)));
      ...
      candidate.getEmployments().forEach(employment -> employee.addEmployment(EmployeeEmployment.builder().employment(employment.getEmployment()).build()));
