...
@Entity
@Table(name = "interview_template_answer", schema = "recruitment_schema", catalog = "fractal")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class InterviewTemplateAnswer extends AbstractEntity {
    ...
    private InterviewTemplateQuestion interviewTemplateQuestion;
