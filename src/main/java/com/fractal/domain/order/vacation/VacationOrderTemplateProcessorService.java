...
class VacationOrderTemplateProcessorService {
    ...
    public Map<String,String> process(VacationOrder order){
        return switch (order.getVacation().getVacationRequest().getVacationType().getCode()) {
            case "ANNUAL" -> getAnnualValues(order);
    ...
    private Map<String,String> getAnnualValues(VacationOrder order) {
